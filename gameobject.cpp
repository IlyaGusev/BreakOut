...
SceneObject::SceneObject(QGraphicsScene *scene, QObject *parent, QGraphicsItem *gparent) :
...
bool SceneObject::collidesWithItem(const SceneObject *other, QPointF* interpoint) const
{
